...
def main(args):
    ...
    # Embedding source and target images into W+, FS space
    ...
    # Hair transfer using the above embedded vector or tensor
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Hair Transfer')
    ...
    parser.add_argument('--warp_front_part', default=True,
                        help='optimize warped_trg img from W+ space and only optimized')
    ...
    # hair related loss
    parser.add_argument('--warp_loss_with_prev_list', nargs='+', help='select among delta_w, hair_slic_large',default=None)
    ...
    parser.add_argument('--im_path1', type=str, default='test-1.png', help='Identity image')
    parser.add_argument('--im_path2', type=str, default='test-2.png', help='Structure image')
    ...
    parser.add_argument('--style_lambda', type=str, default=4e4, help='loss multiplier factor')
